...
typedef enum _P2pIpcMessage__Status
{
    ...
    P2P__IPC_MESSAGE__STATUS__ACKN = 11 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(P2P__IPC_MESSAGE__STATUS)
...
typedef void (*P2pIpcMessage_Closure)(const P2pIpcMessage *message, void *closure_data);
